...
app.get('/task1', (req, res) => {
    res.sendFile('task1.html', {root: __dirname});
});
app.get('/task2', (req, res) => {
    res.sendFile('task2.html', {root: __dirname});
});

app.get('/wasm', (req, res) => {
    res.sendFile('function.wasm', {root: __dirname});
});
...
var wasmCode = new Uint8Array(
    ...
    0,32,1,107,11,135,128,128,128,0,0,32,0,32,1,109,11]);
...
app.get('/:func', (req, res) => {
    ...
    if(wasmInstance.exports[func]){
        res.send(wasmInstance.exports[func](x, y).toString());
    }
    else{
        res.sendStatus(404);
    }
